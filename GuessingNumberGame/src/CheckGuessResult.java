 ...
 * Author: Dawon Jun
 * Date: August 05, 2022
 * Description: This class represents the result of checking if the user number matches
 ...
 * means they they did not win the game. The message field will contain
 * information, such as "you win", "too low", "too high".
 * Note that this class is only used as a method return value and does not
 * do any processing itself.
 */
public class CheckGuessResult {
	...
	/*
	 * default constructor sets message to "no game" and isWin to false
	 */
